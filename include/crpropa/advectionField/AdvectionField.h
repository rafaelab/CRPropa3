 ...
 * @brief Abstract base class for advection fields. 
 * These are used to model the deterministic part of the Fokker-Planck equation. 
 * The getDivergence() method is used to model the adibatic cooling/heating.
 */
 ...
 * @brief Advection field in x-direction with shock at x = 0 and width lShock approximated by tanh() with variable compression ratio vUp/vDown
 */

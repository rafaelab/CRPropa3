...
public:
	...
	/// Checks whether the given point is inside of the surface
...
public:
	...
	/// checks whether the given point is on the "positive" or "negative" side of the infinite plane
...
public:
	 ...
	 * @param point  Point to check if it is inside the sphere
	 */
	virtual bool isInside(const Vector3d& point) const;
	virtual std::string getDescription() const;
};

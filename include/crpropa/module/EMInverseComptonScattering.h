...
public:
	 ...
	 */
	EMInverseComptonScattering(ref_ptr<PhotonField> photonField, bool havePhotons = false, ref_ptr<SamplerEvents> sampler = ref_ptr<SamplerEventsNull>(), double limit = 0.1);

...
class NuclearDecay: public Module {
	...
	private:
		...
		std::vector<std::vector<DecayMode>> decayTable; 
		// decayTable[Z * 31 + N] = vector<DecayMode>
	...
	public:
		...
		*/
		NuclearDecay(bool electrons = false, bool photons = false, bool neutrinos = false, ref_ptr<SamplerEvents> sampling = ref_ptr<SamplerEvents>(new SamplerEventsNull()), double limit = 0.1);

...
public:
	 ...
	 */
	EMDoublePairProduction(ref_ptr<PhotonField> photonField, bool haveElectrons = false, ref_ptr<SamplerEvents> sampler = ref_ptr<SamplerEventsNull>(), double limit = 0.1);

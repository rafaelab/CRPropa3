 ...
 * This type of output can also be used to generate a .tar.gz file if the library zlib is available. 
 * For details see: http://zlib.net/
 */
class TextOutput: public Output {
	...
	public:
		...
		/** Constructor
		 * @param outputType	types of output: Trajectory1D, Trajectory3D, Event1D, Event3D, Everything
		 */

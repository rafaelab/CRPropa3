 ...
 * It provides functions to load and dump grids from/to binary files and plain text files.
 ...
 */
void dumpGridToTxt(ref_ptr<Grid3f> grid, std::string filename, double conversion = 1, bool storeProperties = false);
 ...
 * @param storeProperties	if true the grid properties are stored as a comment
 */
void dumpGridToTxt(ref_ptr<Grid1f> grid, std::string filename, double conversion = 1, bool storeProperties = false);

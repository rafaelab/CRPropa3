...
Vector3d FerriereBase::transformCoordinatesCMZ(const Vector3d& position) {
...
Vector3d FerriereBase::transformCoordinatesDisk(const Vector3d& position) {
	// set galactocentric coordinate system with the Sun at (-8.5,0.,0.) instead of (8.5, 0, 0) to be consistent with JF12 implementation
	double x = -position.x;
	double y = - position.y;
	double z = position.z;
...
std::string FerriereHI::getDescription() const {
	return "Ferriere HI density distribution in the Milky Way.";
}

TargetMedium FerriereHI::getTargetMedium() const {
...
TargetMedium FerriereHII::getTargetMedium() const {
...
std::string FerriereH2::getDescription() const {
	return "Ferriere H2 density distribution in the Milky Way.";
}

TargetMedium FerriereH2::getTargetMedium() const {
